...
<body>
        ...
        <div class="container uk-margin-medium-top" style="position: relative; width: 93%; margin: auto;">
            <div class="" style="height: 350px; background-image: url('https://plus.unsplash.com/premium_photo-1683733841845-29e325968e27?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); background-size: cover; background-position: center;">
                ...
                <div class="uk-overlay uk-position-center uk-light">
                    <h2 class="uk-heading-small" data-uk-scrollspy="cls: uk-animation-slide-left-small; repeat: true; delay: 300">Digital Marketing</h2>
                </div>
            </div>
        </div>
    </div>
                       ...
                       <div class="uk-grid-large" data-uk-grid>
                           <div class="uk-width-1-2@m uk-flex uk-flex-middle">
                               <div>
                                   ...
                                   <h2 class="uk-heading-small uk-margin-medium-top">Digital Marketing</h2>
                                   <p class="uk-text-large uk-width-4-5@m">
                                        Boost your brand’s online presence with JemsaMediaTech's expert digital marketing services. 
                                        From SEO and social media management to PPC, content marketing, and email campaigns, 
                                        we craft data-driven strategies that attract, engage, and convert. 
                                        Whether you want higher search rankings or increased customer engagement, 
                                        we deliver results that drive growth. Let’s take your brand to the next level!
                                   </p>
    ...
    <div class="uk-section-large uk-section-primary uk-light">
        <div class="uk-container">
            ...
            <h2 class="uk-heading-small uk-margin-large" style="margin-bottom: 0;" >Our Digital Marketing Services</h2>
                ...
                <div class="uk-child-width-1-4@l uk-child-width-1-3@m uk-child-width-1-2@s uk-grid-match uk-margin-large-top uk-slider-items"
                    ...
                    <div class="uk-text-left ">
                        <div class="uk-padding-medium uk-border-medium">
                            ...
                            <h3 class="uk-margin-remove uk-text-uppercase uk-h5 uk-letter-spacing-small">Influencer Identification and Outreach</h3>

                            <p> We identify influencers who align with your brand values and audience, 
                                handling outreach to secure authentic partnerships that enhance your brand’s visibility.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="uk-text-left">
                        <div class="uk-padding-medium uk-border-medium">
                            ...
                            <p> We design tailored influencer marketing strategies, including content planning, 
                                collaboration guidelines, and goals, ensuring campaigns align with your overall marketing objectives.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="uk-text-left">
                        <div class="uk-padding-medium uk-border-medium">
                            <img class=" uk-margin-medium uk-icon-large" src="../images/influencer.png" alt="Icon"
                                data-uk-svg style="height: 70px;">
                            <h3 class="uk-margin-remove uk-text-uppercase uk-h5 uk-letter-spacing-small">Content Collaboration and Creation</h3>

                            <p>We facilitate collaboration between your brand and influencers to create engaging, 
                                authentic content that resonates with their followers and promotes your products or services.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="uk-text-left">
                        <div class="uk-padding-medium uk-border-medium">
                            <img class=" uk-margin-medium uk-icon-large" src="../images/influencer.png" alt="Icon"
                                data-uk-svg style="height: 70px;">
                            <h3 class="uk-margin-remove uk-text-uppercase uk-h5 uk-letter-spacing-small">Performance Tracking and Reporting </h3>

                            <p>We monitor campaign performance using key metrics, 
                                providing detailed reports that highlight successes and offer insights for optimizing future influencer marketing efforts.
                            </p>
                        </div>
                    </div>
