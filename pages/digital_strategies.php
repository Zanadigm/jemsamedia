...
<body>
        ...
        <div class="container uk-margin-medium-top" style="position: relative; width: 93%; margin: auto;">
            <div class="" style="height: 350px; background-image: url('https://plus.unsplash.com/premium_photo-1683733841845-29e325968e27?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'); background-size: cover; background-position: center;">
                ...
                <div class="uk-overlay uk-position-center uk-light">
                    <h2 class="uk-heading-small" data-uk-scrollspy="cls: uk-animation-slide-left-small; repeat: true; delay: 300">Digital Strategies</h2>
                </div>
            </div>
        </div>
    </div>
                       ...
                       <div class="uk-grid-large" data-uk-grid>
                           <div class="uk-width-1-2@m uk-flex uk-flex-middle">
                               <div>
                                   ...
                                   <h2 class="uk-heading-small uk-margin-medium-top">Digital Strategies</h2>
                                   <p class="uk-text-large uk-width-4-5@m">
                                        We focus on creating customized plans that help businesses leverage digital channels and technologies to 
                                        achieve their objectives. Our agency works closely with clients to develop tailored solutions in areas like digital marketing, 
                                        social media, content creation, SEO, and e-commerce. By analyzing data, understanding customer behavior, 
                                        and optimizing online presence, the agency ensures businesses can reach their target audience, 
                                        boost engagement, and drive growth. 
                                        The goal is to help clients stay competitive in the ever-evolving digital landscape.
                                   </p>
    ...
    <div class="uk-section-large uk-section-primary uk-light">
        <div class="uk-container">
            ...
            <h2 class="uk-heading-small uk-margin-large" style="margin-bottom: 0;" >Our Digital Strategy Services</h2>
                ...
                <div class="uk-child-width-1-4@l uk-child-width-1-3@m uk-child-width-1-2@s uk-grid-match uk-margin-large-top uk-slider-items"
                    ...
                    <div class="uk-text-left">
                        <div class="uk-padding-medium uk-border-medium">
                            ...
                            <p> We design tailored influencer marketing strategies, including content planning, collaboration guidelines, and goals, ensuring campaigns align with your overall marketing objectives.</p>
                        </div>
                    </div>
